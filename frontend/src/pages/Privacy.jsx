    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col transition-colors">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-16">
        ...
        <div className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">What we access</h2>
            <p>
              When you connect Gmail, CatchMail requests read-only access to your inbox
              (<code className="text-sm bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">gmail.readonly</code>)
              and permission to create events on your Google Calendar
              (<code className="text-sm bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">calendar.events</code>),
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">What we store</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Third parties we use</h2>
            <ul className="list-disc pl-5 space-y-1.5">
              <li>
                <strong className="text-slate-900 dark:text-white">Google</strong> — Gmail and Calendar
                access, and sign-in.
              </li>
              <li>
                <strong className="text-slate-900 dark:text-white">Google Gemini</strong> — email
              ...
              <li>
                <strong className="text-slate-900 dark:text-white">Supabase</strong> — database hosting for
                your account and task data.
              </li>
              <li>
                <strong className="text-slate-900 dark:text-white">Resend</strong> — sends the optional daily
                digest email.
              </li>
              <li>
                <strong className="text-slate-900 dark:text-white">Razorpay</strong> — processes subscription
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Your controls</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Changes to this policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Contact</h2>
            <p>
