    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col transition-colors">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-16">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">1. Using CatchMail</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">2. Plans and billing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">3. Acceptable use</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">4. No warranty</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">5. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">6. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground dark:text-white mb-2">7. Contact</h2>
            <p>
